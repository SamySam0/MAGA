...
def train(
    ...
    for epoch in range(1, n_epochs+1):
        ...
        if epoch % log_loss_per_n_epoch == 0 or epoch == n_epochs:
            ...
            print(f"Valid Mean Loss: {val_mean_loss}, Valid Tail Loss: {val_tail_loss}, Valid Mean Acc: {val_mean_acc}, Valid Tail Acc: {val_tail_acc}, LR: {lrs[-1]}", end='')
        ...
        print(f"\nTest Experiment => Valid: {valid_s}, Unique: {unique_s}, Novel: {novel_s}, Valid_w_corr: {valid_w_corr_s}")
